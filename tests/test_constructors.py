...
class TestYamlScalarConstruction:
    ...
    def test_rejects_unknown_style(self) -> None:
        with pytest.raises(ValueError, match="unknown style"):
            yarutsk.YamlScalar("v", style="bold")  # type: ignore[arg-type]

    def test_style_mutable_after_construction(self) -> None:
        s = yarutsk.YamlScalar("v", style="plain")
        s.style = "double"
        assert s.style == "double"

    def test_tag_mutable_after_construction(self) -> None:
...
class TestYamlScalarEquality:
    def test_eq_primitive(self) -> None:
    ...
    def test_eq_other_scalar(self) -> None:
        assert yarutsk.YamlScalar("x") == yarutsk.YamlScalar("x")

    def test_neq_different_value(self) -> None:
        assert yarutsk.YamlScalar("a") != yarutsk.YamlScalar("b")

    def test_neq_different_type(self) -> None:
...
class TestYamlScalarReprAndToDict:
    ...
    def test_to_python_returns_primitive(self) -> None:
...
class TestYamlScalarDumpStyle:
    def _doc_with(self, val: yarutsk.YamlScalar) -> str:
        doc = yarutsk.YamlMapping()
        doc["k"] = val
        return yarutsk.dumps(doc)

    def test_plain_style(self) -> None:
...
class TestYamlMappingConstruction:
    ...
    def test_block_style_explicit(self) -> None:
    ...
    def test_tag_and_style(self) -> None:
    ...
    def test_rejects_unknown_style(self) -> None:
        with pytest.raises(ValueError, match="unknown style"):
            yarutsk.YamlMapping(style="sideways")  # type: ignore[arg-type]

    def test_is_not_dict_subclass(self) -> None:
        # Standalone pyclass — `YamlMapping` deliberately does *not* extend
        # `dict`. Use `to_python()` for plain-dict interop.
        m = yarutsk.YamlMapping()
        assert not isinstance(m, dict)
        assert isinstance(m, yarutsk.YamlMapping)

    def test_supports_dict_operations(self) -> None:
        m = yarutsk.YamlMapping(style="flow")
        m["a"] = 1
        m["b"] = 2
        assert m["a"] == 1
...
class TestYamlMappingDumpStyle:
    def test_flow_mapping_emits_braces(self) -> None:
        m = yarutsk.YamlMapping(style="flow")
        m["x"] = 1
        m["y"] = 2
        doc = yarutsk.YamlMapping()
    ...
    def test_block_mapping_no_braces(self) -> None:
        m = yarutsk.YamlMapping(style="block")
        m["x"] = 1
        doc = yarutsk.YamlMapping()
        doc["p"] = m
    ...
    def test_tag_on_nested_mapping_in_output(self) -> None:
    ...
    def test_style_preserved_after_setitem_roundtrip(self) -> None:
        doc = yarutsk.loads(
            dedent("""\
            outer:
              x: 1
...
class TestYamlSequenceConstruction:
    ...
    def test_rejects_unknown_style(self) -> None:
        with pytest.raises(ValueError, match="unknown style"):
            yarutsk.YamlSequence(style="zigzag")  # type: ignore[arg-type]

    def test_is_not_list_subclass(self) -> None:
        s = yarutsk.YamlSequence()
        assert not isinstance(s, list)
        assert isinstance(s, yarutsk.YamlSequence)

    def test_supports_list_operations(self) -> None:
        s = yarutsk.YamlSequence(style="flow")
        s.extend([1, 2, 3])
        assert list(s) == [1, 2, 3]
...
class TestYamlSequenceDumpStyle:
    def test_flow_sequence_emits_brackets(self) -> None:
        s = yarutsk.YamlSequence(style="flow")
        s.extend([1, 2, 3])
        doc = yarutsk.YamlMapping()
        doc["nums"] = s
    ...
    def test_block_sequence_no_brackets(self) -> None:
    ...
    def test_tag_on_nested_sequence_in_output(self) -> None:
...
class TestStyledScalarAssignmentPaths:
    ...
    def test_mapping_setdefault_does_not_overwrite(self) -> None:
    ...
    def test_sequence_setitem(self) -> None:
        doc = yarutsk.loads(
            dedent("""\
            - hello
            - world
    ...
    def test_sequence_extend(self) -> None:
        doc = yarutsk.loads("[]")
        assert isinstance(doc, yarutsk.YamlSequence)
        doc.extend(
            [
...
class TestStyledContainerAssignmentPaths:
    def test_mapping_setitem_flow_mapping(self) -> None:
    ...
    def test_mapping_setitem_flow_sequence(self) -> None:
    ...
    def test_sequence_append_flow_mapping(self) -> None:
        doc = yarutsk.loads("[]")
        assert isinstance(doc, yarutsk.YamlSequence)
        m = yarutsk.YamlMapping(style="flow")
        m["k"] = "v"
    ...
    def test_sequence_append_flow_sequence(self) -> None:
        doc = yarutsk.loads("[]")
        assert isinstance(doc, yarutsk.YamlSequence)
    ...
    def test_mapping_update_with_styled_container(self) -> None:
        doc = yarutsk.loads("a: 1")
        assert isinstance(doc, yarutsk.YamlMapping)
        m = yarutsk.YamlMapping(style="flow")
        m["x"] = 9
...
class TestDumperWithStyledNodes:
    ...
    def test_scalar_style_and_tuple_tag(self) -> None:
        class Foo:
    ...
    def test_mapping_style_and_tuple_tag(self) -> None:
        class Point:
            def __init__(self, x: int, y: int) -> None:
                self.x, self.y = x, y

        def dump(p: Point) -> tuple[str, yarutsk.YamlMapping]:
            m = yarutsk.YamlMapping(style="flow")
            m["x"] = p.x
            m["y"] = p.y
            return ("!point", m)
    ...
    def test_sequence_style_and_tuple_tag(self) -> None:
        class Bag:
            def __init__(self, items: list[int]) -> None:
                self.items = items

        def dump(b: Bag) -> tuple[str, yarutsk.YamlSequence]:
            s = yarutsk.YamlSequence(style="flow")
            s.extend(b.items)
            return ("!bag", s)
    ...
    def test_tuple_tag_overrides_node_tag(self) -> None:
    ...
    def test_dumper_block_mapping(self) -> None:
        class Cfg:
            pass

        def dump(c: Cfg) -> tuple[str, yarutsk.YamlMapping]:
            m = yarutsk.YamlMapping(style="block")
            m["debug"] = True
            return ("!cfg", m)
    ...
    def test_dumper_scalar_single_quoted(self) -> None:
        class Name:
            def __init__(self, v: str) -> None:
                self.v = v
...
class TestConstructorTagInOutput:
    def test_mapping_tag_nested(self) -> None:
    ...
    def test_sequence_tag_nested(self) -> None:
    ...
    def test_scalar_tag_nested(self) -> None:
        doc = yarutsk.YamlMapping()
...
class TestCommentsFromScratch:
    ...
    def test_mapping_inline_comment_on_entry(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc.node("a").comment_inline = "note"
        assert yarutsk.dumps(doc) == "a: 1  # note\n"

    def test_mapping_block_comment_on_entry(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc.node("a").comment_before = "above"
        assert yarutsk.dumps(doc) == "# above\na: 1\n"

    def test_mapping_entry_both_comments(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc.node("a").comment_before = "above"
    ...
    def test_multi_line_comment_before(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
    ...
    def test_sequence_item_inline_comment(self) -> None:
    ...
    def test_sequence_item_block_comment(self) -> None:
        seq = yarutsk.YamlSequence()
        seq.extend([1, 2])
        seq.node(0).comment_before = "first"
        assert yarutsk.dumps(seq) == "# first\n- 1\n- 2\n"

    def test_scalar_constructor_with_comments(self) -> None:
        doc = yarutsk.YamlMapping()
    ...
    def test_comment_clear_roundtrip(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
    ...
    def test_nested_mapping_comment_on_child(self) -> None:
    ...
    def test_flow_mapping_comments_not_emitted(self) -> None:
...
class TestAnchorsAndAliasesFromScratch:
    ...
    def test_anchor_via_node_setter(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = "hello"
        doc.node("a").anchor = "g"
        assert yarutsk.dumps(doc) == "a: &g hello\n"

    def test_alias_reference_to_scalar(self) -> None:
        doc = yarutsk.YamlMapping()
    ...
    def test_alias_reference_to_mapping(self) -> None:
        inner = yarutsk.YamlMapping()
        inner["x"] = 1
        inner.anchor = "cfg"
        doc = yarutsk.YamlMapping()
    ...
    def test_get_alias_returns_anchor_name(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = "v"
        doc.node("a").anchor = "x"
        doc["b"] = "v"
    ...
    def test_anchor_clear_via_none(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = "v"
        doc.node("a").anchor = "n"
...
class TestBlankLinesFromScratch:
    def test_blank_lines_before_entry(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc["b"] = 2
    ...
    def test_blank_lines_before_clamped_at_255(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc["b"] = 2
    ...
    def test_trailing_blank_lines_after_mapping(self) -> None:
        inner = yarutsk.YamlMapping()
        inner["x"] = 1
    ...
    def test_trailing_blank_lines_after_sequence(self) -> None:
        seq = yarutsk.YamlSequence()
        seq.extend([1, 2])
    ...
    def test_blank_lines_before_sequence_item(self) -> None:
        seq = yarutsk.YamlSequence()
        seq.extend([1, 2])
...
class TestDocumentMarkersFromScratch:
    def test_explicit_start_on_mapping(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc.explicit_start = True
        assert yarutsk.dumps(doc) == "---\na: 1\n"

    def test_explicit_end_on_mapping(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
        doc.explicit_end = True
        assert yarutsk.dumps(doc).endswith("...\n")

    def test_yaml_version_directive(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["a"] = 1
    ...
    def test_yaml_version_rejects_invalid(self) -> None:
        doc = yarutsk.YamlMapping()
        with pytest.raises(ValueError):
            doc.yaml_version = "not-a-version"

    def test_tag_directive(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["x"] = 1
    ...
    def test_all_document_markers_on_sequence(self) -> None:
        seq = yarutsk.YamlSequence()
        seq.append(1)
    ...
    def test_document_markers_on_scalar(self) -> None:
...
class TestSpecialScalarsFromScratch:
    def test_date_scalar(self) -> None:
        doc = yarutsk.YamlMapping()
    ...
    def test_bytes_scalar_base64_encoded(self) -> None:
        doc = yarutsk.YamlMapping()
    ...
    def test_bytearray_scalar(self) -> None:
        doc = yarutsk.YamlMapping()
        doc["blob"] = yarutsk.YamlScalar(bytearray(b"abc"))
        out = yarutsk.dumps(doc)
        assert "!!binary" in out

    def test_date_roundtrip_via_load(self) -> None:
        ...
        assert isinstance(reloaded, yarutsk.YamlMapping)
        assert reloaded["d"] == datetime.date(2024, 1, 1)

    def test_bytes_roundtrip_via_load(self) -> None:
        doc = yarutsk.YamlMapping()
    ...
    def test_custom_tag_overrides_binary_default(self) -> None:
        doc = yarutsk.YamlMapping()
...
class TestCombinedFromScratch:
    ...
    def test_build_from_scratch_with_all_features(self) -> None:
